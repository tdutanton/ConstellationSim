 ...
 * <p>
 * Представляет собой Spring-компонент, обеспечивающий централизованное
 * хранилище объектов типа {@link SatelliteConstellation} по их названиям.
 * Поддерживает безопасное добавление группировок и спутников с проверкой
 * на дублирование и существование целевой группировки.
 * </p>
 */
@Component
public class ConstellationRepository {
     ...
     * <p>
     * Если группировка с таким названием уже существует, добавление не производится,
     * и выводится соответствующее сообщение в консоль.
     * </p>
     *
     ...
     * или в подклассах. Если название группировки {@code null}, выбрасывается
     ...
     */
    protected SatelliteConstellation constellationByName(String constellationName) {
    ...
    private void safetyDeleteSatellite(String constellationName, Satellite satellite) {
        if (isInRepository(constellationName)) { // ← проверка по имени
            ...
            System.out.printf("Удалён спутник %s из группировки %s%n", satellite.getName(), constellation.getConstellationName()); // исправлено сообщение
            return;
        }
        System.out.println("Группировки " + constellationName + " не существует");
    }

    public boolean containsConstellations() {return !constellations.isEmpty();}
}