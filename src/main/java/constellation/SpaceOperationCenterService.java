 ...
 * <p>
 * Обеспечивает высокоуровневое взаимодействие с репозиторием спутниковых группировок:
 * создание, активацию, выполнение миссий и отображение статуса группировок.
 * Все операции включают базовую валидацию входных данных и вывод информационных сообщений
 * в консоль при выполнении действий.
 * </p>
 */
@Service
public class SpaceOperationCenterService {
     ...
     * а его название — ненулевым и не пустым/не состоящим только из пробелов.
     *
    ...
    /**
     * Проверяет корректность названия группировки: оно не должно быть {@code null}
     * и не должно быть пустой или содержащей только пробелы строкой.
     *
    ...
    /**
     * Проверяет корректность спутника: он не должен быть {@code null},
     * а его имя — ненулевым и не пустым/не состоящим только из пробелов.
     *
     ...
     * <p>
     * Валидация спутника и названия группировки выполняется внутри репозитория.
     * Если группировка не существует, операция завершится без эффекта.
     * </p>
     *
     ...
     * <p>
     * Перед выполнением проверяется существование группировки.
     * При успешном запуске выводится заголовок в консоль.
     * </p>
     *
     * @param constellationName название группировки
     */
     ...
     * <p>
     * Перед активацией проверяется существование группировки.
     * При успешной активации выводится заголовок в консоль.
     * </p>
     *
     * @param constellationName название группировки
     */
     ...
     *   <li>список их состояний ({@link SatelliteState}),</li>
