...
/**
 * Юнит-тесты для репозитория спутниковых группировок.
 * Проверяет все публичные методы без использования внешних зависимостей.
 */
...
public class ConstellationRepositoryUnitTest {
    ...
    class DeletingConstellation {
        ...
        void shouldDeleteExistingConstellation() {
            ...
            assertFalse(repository.containsConstellations(), "Репозиторий должен быть пустым после удаления");
        }
